...
export default function page() {
    return (
        <main aria-label="main-content">
            ...
            <h2 className="text-xl font-bold pl-5"><br />What are the Risk Score Levels?</h2>
            <div className="pl-5">
                <p><br /><b>0 - 1 (Very Low Risk):</b> A Risk Score of 0 to 1 indicates a very low risk of foreign adversary involvement. No significant indicators suggest potential compromise or influence that could impact defense or federal contract eligibility. Standard due diligence is still advised.</p>
