    ...
    return (
        <main>
            ...
            <p className = "pl-5"><br />Navy SBIR / STTR Forms & Templates (Including Volume VII Disclosures 
                ...
                <a href="http://www.navysbir.com/links_forms.htm"></a></p>
            <p className = "pl-5"><br />Cybersecurity Maturity Model Certification (CMMC) 2.0 FAQs:
                <a href="https://dodcio.defense.gov/Portals/0/Documents/CMMC/CMMC-FAQs.pdf?ver=Uy1I0M3byGaIO6hN43Y_dA%3d%3d"></a></p>
            <p className = "pl-5"><br />Register with SAM:
                <a href="https://sam.gov/content/entity-registration"></a></p>
            <p className = "pl-5"><br />Small Business Administration DSBS Company Lookup:
                <a href="https://dsbs.sba.gov/search/dsp_dsbs.cfm"></a></p>
            <p className = "pl-5"><br />SBIR Due Diligence Memorandum (May 2024):
                <a href="https://media.defense.gov/2024/May/23/2003471996/-1/-1/1/DUE_DILIGENCE_PROGRAM_OSD003584_24_RES.PDF"></a></p>
            <p className = "pl-5"><br />Due Diligence Documentation Changes in Response to Above Memorandum:
                <a href="https://media.defense.gov/2024/Apr/16/2003440556/-1/-1/0/DOD_SBIR_24.2_BAA_PREFACE.PDF"></a></p>
            <p className = "pl-5"><br />SBIR and STTR Extension Act of 2022:
                <a href="https://www.congress.gov/117/plaws/publ183/PLAW-117publ183.pdf"></a></p>
            <p className = "pl-5"><br />CFR Title 15 Documentation:
                <a href="https://www.ecfr.gov/current/title-15/"></a></p>
            <p className = "pl-5"><br />Federal Acquisition Regulation (FAR) Documentation:
                <a href="https://www.acquisition.gov/browse/index/far"></a></p>
        </main>
    );
}