export default function page(){
    ...
    <main>
        ...
        <p className = "pl-5">CMMC 2.0 is a certification that the federal government will begin requiring 
        ...
        <p className = "pl-5">Each level of CMMC takes approximately 12-18 months to reach certification standards. 
        ...
        <p className = "pl-5">More information can be found here from the DoD`&apos;`s CIO website:
            <a href="https://dodcio.defense.gov/cmmc/About/"></a></p>
    </main>
    );
}